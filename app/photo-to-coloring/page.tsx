...
export default function PhotoToColoringPage() {
  ...
  const handleFile = useCallback(
    async (file: File) => {
      ...
      reader.onload = async (e) => {
        ...
        try {
          const processed = await processImage(result, edgeSensitivity, lineThickness);
          clearInterval(interval);
          setProgress(100);
          setTimeout(() => {
    ...
    [edgeSensitivity, lineThickness, processImage, setUploadedImage, setProcessedImage, setIsProcessing]
  );
  ...
  const handleReprocess = useCallback(async () => {
    ...
    try {
      const processed = await processImage(uploadedImage, edgeSensitivity, lineThickness);
      clearInterval(interval);
      setProgress(100);
      setTimeout(() => {
        setProcessedImage(processed);
  ...
  }, [uploadedImage, edgeSensitivity, lineThickness, processImage, setProcessedImage, setIsProcessing]);
                    ...
                    <div className="p-4 flex items-center justify-center min-h-[300px]">
                      {isProcessing ? (
                        <div className="text-center w-full max-w-sm">
                          ...
                          <p className="text-gray-500 mb-3">Generating your coloring page...</p>
